...
<html lang="en">
    <head>
        ...
        <title>Duta Sarana Makmur</title>
        <!-- Favicon-->
            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end">
                        <h1 class="text-white font-weight-bold">Duta Sarana Makmur</h1>
                        <hr class="divider" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 mb-5">Kelola Persediaan Barang Barang Duta Sarana Makmur</p>
                        <a class="btn btn-primary btn-xl" href="inventory.php">Inventory</a>
                    </div>
                </div>
            </div>
        </header>
